...
function main() {
    if (document.querySelector(".claimable-bonus__icon")) {
        ...
        div.innerHTML = `<div class="chat-line__message" data-a-target="chat-line-message" data-test-selector="chat-line-message"><span class="chat-author__display-name" style="color: rgb(220, 0, 0);">TwitchPointsCollector: Bonus collected</span></div>`
